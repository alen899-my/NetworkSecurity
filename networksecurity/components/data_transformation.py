...
class DataTransformation:
    ...
    def get_data_transformer(cls)->Pipeline:
        logging.info("entered get data transformer object method of transformation class")
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info("initailiose with  parameter")
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        logging.info("entered initiaate transforamation method class"
        )
        try:
